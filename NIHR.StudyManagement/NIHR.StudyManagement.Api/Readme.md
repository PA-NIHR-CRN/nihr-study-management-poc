...
WORKDIR /src
COPY ["NIHR.StudyManagement.Api.csproj", "NIHR.StudyManagement.Api/"]
RUN dotnet restore "NIHR.StudyManagement.Api/NIHR.StudyManagement.Api.csproj"

WORKDIR "/src/NIHR.StudyManagement.Api"
COPY . .
RUN dotnet build "NIHR.StudyManagement.Api.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "NIHR.StudyManagement.Api.csproj" \
...
Execute unit tests
```
    cd "NIHR.StudyManagement.Api/test/NIHR.StudyManagement.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "NIHR.StudyManagement.Api/src/NIHR.StudyManagement.Api"
