...
{
    public partial class study_managementContext : DbContext
    {
        public study_managementContext()
        {
        }

        public study_managementContext(DbContextOptions<study_managementContext> options)
            : base(options)
        {
        }
